...
PREFIX_QC="~/Documents/GitHub/Leptidea_rec_rate_div/02_diversity/01b_vcf_qc/output/cat_allsites"
```
...
#Filtering on depth
mindepth=?
maxdepth (approx 2x mean depth) = 25
...
plot(ind_het$E.HET~as.factor(ind_het$INDV), main="Expected heterozygosity per ind")

#plot observed Heterozygosity
plot(ind_het$O.HET~as.factor(ind_het$INDV), main="Observed heterozygosity per ind")
